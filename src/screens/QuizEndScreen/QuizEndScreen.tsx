...
const QuizEndScreen = ({
  ...
  return (
    <View
      style={[
        GStyles.screen,
        { backgroundColor: Colors[theme].background, alignItems: "center" },
      ]}
    >
      <Image
        ...
        resizeMode={"contain"}
      />
      <Text style={[Title.Section, { color: Colors[theme].neutral[500] }]}>
        {isHappy ? happyText : sadText}
      </Text>
      <Text
        style={[
          Title.Principal,
          {
            ...
            color: isHappy
              ...
              : Colors[theme].tertiary[500],
          },
        ]}
      >
        {percentage}%
      </Text>
      <Text style={[Title.Secondary, { color: Colors[theme].neutral[100], marginBottom:10 }]}>
